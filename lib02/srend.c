 ...
 * knowledge.
 *
 * This macro together with the bresenham D update function
 * (Bresenham_DrawCircle_UpRight_Update) should be enough for one to implement
 * any circle drawing function. Check the 3 circle drawing functions that
 * exist in here to find out how to use this macro.
 */
#define WITH_BRESENHAM_DRAWING_CIRCLE(s, cx, cy, rad) \
...
DrawCircle(struct Screen *s,
           ...
           ColorUint color)
{
  WITH_BRESENHAM_DRAWING_CIRCLE(s, cx, cy, rad) {
